...
import AmountUsdEquivalent from "./AmountUsdEquivalent/AmountUsdEquivalent.jsx";
import SwapFormDivider from "./SwapFormDivider/SwapFormDivider.jsx";
...
const Form = styled.div`
	...
	${respondDown(Breakpoints.sm)`
        width: 100%;
        padding: ${({ $isEmbedded }) =>
					$isEmbedded ? "0" : "6.6rem 0.8em 2rem"};
        box-shadow: unset;
    `};
`;
